						...
						<div class="frontside">
							<div class="card">
								<div class="card-body text-center">
									<p>
										<img class=" img-fluid" src="img/adm.jpeg" alt="card image">
									</p>
						...
						<div class="backside">
							<div class="card">
								<div class="card-body text-center mt-4">
									<h4 class="card-title">Si eres Administrador de Las
										canchas sinteticas la Catedral del futbol</h4>
									<a href="loginAdministrador.jsp"><button type="button"
											class="btn btn-primary">Ir al Login</button></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="mainflip flip-0">
						<div class="frontside">
							<div class="card">
								<div class="card-body text-center">
									<p>
										<img class=" img-fluid" src="img/bodega.jpg" alt="card image">
									</p>
						...
						<div class="backside">
							<div class="card">
								<div class="card-body text-center mt-4">
									<h4 class="card-title">Si eres Administrador de las
										bodegas y el inventario de Las canchas sinteticas la Catedral
										del futbol</h4>
									<a href="#"><button type="button" class="btn btn-primary">Ir
											al Login</button></a>
								</div>
							</div>
						</div>
					...
					<div class="mainflip flip-0">
						<div class="frontside">
							<div class="card">
								<div class="card-body text-center">
									<p>
										<img class=" img-fluid" src="img/cliente.jpg" alt="card image">
									</p>
						...
						<div class="backside">
							<div class="card">
								<div class="card-body text-center mt-4">
									<h4 class="card-title">Si eres cliente de La Catedral del
										futbol o te interesa serlo</h4>
									<a href="loginCliente.jsp"><button type="button"
											class="btn btn-primary">Ir al Login</button></a>
								</div>
							</div>
						</div>
