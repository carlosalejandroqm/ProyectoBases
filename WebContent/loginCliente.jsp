...
<title>Login para los clientes de las canchas sinteticascanchas
	sinteticas</title>
				...
				<form
					...
					<div class="form-label-group">
						<input type="text" id="inputEmail" class="form-control"
							placeholder="Digite correo o usuario" name="nombre" required
							autofocus> <label for="inputEmail">Nombre Cliente</label>
					</div>
					<div class="form-label-group">
						<input type="password" id="inputPassword" class="form-control"
							name="pass" placeholder="Digite su Contraseña" required>
					...
					<div class="custom-control custom-checkbox mb-3">
						<input type="checkbox" class="custom-control-input"
							...
							for="customCheck1">Recordar ContraseÃ±a</label>
					</div>
					<button
						class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2"
						type="submit">Ingresar</button>
					<div>
						¿No estas registrado? <a href="registroCliente.jsp">Crear una
							cuenta</a>
					</div>
					<div>
