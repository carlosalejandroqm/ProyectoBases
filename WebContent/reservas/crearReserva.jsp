    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
                <h3 class="login-heading mb-4">Crear Reserva</h3>
                <form>
                    <div class="form-label-group">
                        <input type="text" id="inputFechaIni" class="form-control" placeholder="Fecha Inicio" required
                            autofocus><br>
                    </div>
                    <div class="form-label-group">
                        <input type="text" id="inputFechaFin" class="form-control" placeholder="Fecha fin" required
                            autofocus> <br>
                    </div>
                    <div class="form-label-group">
                        <input type="text" id="inputVigencia" class="form-control" placeholder="Vigencia" required
                            autofocus> <br>
                    </div>
                    <button class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2"
                        type="submit">Registrar Reserva
                    </button>
                </form>
            </div>
        </div>
